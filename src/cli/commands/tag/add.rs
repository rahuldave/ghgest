...
impl Command {
  pub fn call(&self, ctx: &AppContext) -> cli::Result<()> {
    ...
    match resolved.entity_type {
      EntityType::Task => crate::cli::commands::tags::tag_entity(
        ctx,
        &self.id,
        &self.tags,
        "task",
      ...
      EntityType::Artifact => crate::cli::commands::tags::tag_entity(
        ctx,
        &self.id,
        &self.tags,
        "artifact",
      ...
      EntityType::Iteration => crate::cli::commands::tags::tag_entity(
        ctx,
        &self.id,
        &self.tags,
        "iteration",
