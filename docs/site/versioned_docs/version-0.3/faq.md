...
- **Configuration** supports TOML, JSON, and YAML. See [configuration](./configuration/index.md) for details.
...
body content across both tasks and artifacts. See [gest search](./cli/search.md) for the full
reference.
...
See [gest serve](./cli/serve.md) for options.
